...
final class BitbucketClient implements RegistryClient
{
    ...
    {
        $branch = config('bladecn-laravel.source.bitbucket.branch', 'main');

        return "https://bitbucket.org/{$repo->owner}/{$repo->repo}/raw/{$branch}";
    }
